...
public interface Constant {
    ...
    interface SqlQuery{
        ...
        String REGISTRATION_CUSTOMER_IN_BANK = "update customers set credit_bank_id = ?, account_id_in_credit_bank = ?, shared_key_with_credit_bank = ?, deposit_bank_id = ?, account_id_in_deposit_bank = ?, shared_key_with_deposit_bank = ?, current_money = ? where email = ?";
